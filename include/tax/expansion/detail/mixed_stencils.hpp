...
//
// This header does NOT include tax/expansion/scheme/mixed.hpp; that header includes
...
namespace tax
{
/// Forward declaration; MixedScheme is fully defined in tax/expansion/scheme/mixed.hpp.
