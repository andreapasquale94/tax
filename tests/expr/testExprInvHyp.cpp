...
{
    auto [x, y] = TEn< 3, 2 >::variables( { 0.6, 0.4 } );
    TEn< 3, 2 > r = asinh( x );
...
{
    auto [x, y] = TEn< 3, 2 >::variables( { 1.8, 0.2 } );
    TEn< 3, 2 > r = acosh( x );
    EXPECT_NEAR( r.coeff( { 0, 1 } ), 0.0, kTol );
...
{
    auto [x, y] = TEn< 3, 2 >::variables( { 0.4, 0.6 } );
    TEn< 3, 2 > r = atanh( x );
    EXPECT_NEAR( r.coeff( { 0, 1 } ), 0.0, kTol );
